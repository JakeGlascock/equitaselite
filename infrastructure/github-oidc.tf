# GitHub Actions OIDC provider + scoped deploy role.
# No long-lived AWS access keys are stored anywhere — workflows assume this
# role at runtime by presenting a signed OIDC token from GitHub's identity provider.
  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        StringLike = {
          # Scope to this repo only, but allow any branch/tag/PR
