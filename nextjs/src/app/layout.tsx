  ...
  return (
    <html lang="en" className={`${playfair.variable} ${inter.variable} ${plexSans.variable}`}>
      <head>
        ...
        */}
        {/*
          Self-hosted Material Symbols subset — only the 51 glyphs the app
          actually uses, ~62KB instead of the 3.8MB full variable font.
          ...
          changes — see globals.css comment for the workflow):
            ...
            delete, description, event, expand_more, explore, fact_check,
            forum, group, handshake, help, hourglass_empty, inbox,
