...
// Pitch-deck links. Parallel to PreviewTokensPanel but without the
// "view as" demo-profile selector — deck tokens serve a static HTML
// render of pitch.md (generated by Marp at deploy time), not a
// walkthrough of the live product.
export default function DeckTokensPanel() {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <label className="block md:col-span-3">
            ...
            <input
              ...
              placeholder="e.g. Sequoia — John D. (deck)"
            />
          </label>
